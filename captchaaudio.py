...
DATA_DIR = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'data/audio')
...
if __name__ == '__main__':
    audio = AudioCaptcha()
    for i in range(100):
        label = ''.join(random.sample(string.digits, 4))
        print label
        audio.write(label, 'captchas/pycaptcha_audio/'+str(i)+'.wav')